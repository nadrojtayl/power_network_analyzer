/////////////////////////////////////////////
/* Stupid technical debt - sorry, this isnt clean, will clean later
*/
"use strict";
var coords = [121.41312,24.914632,121.620487,25.032897]
//
...
function get_list_unfound_nodes(){
    var nodes;
    power_data["Ways"].forEach(function(way){
        nodes = way["node_references"];
...
//taipei southern less urban area:
var coords = [121.41312,24.914632,121.620487,25.032897]
//
...
///////////Relevant stuff built off functions above

var left_bottom_right_top = left + "," + bottom + "," + right + "," + top;

load_serialized_data_if_its_there(left_bottom_right_top);
get_list_unfound_nodes();
 console.log(unfound);
// change_node_or_way_references_to_objects(power_data);
get_unfound();
// serialize_data_as_json_file_in_serialized_directory(left_bottom_right_top,power_data);
